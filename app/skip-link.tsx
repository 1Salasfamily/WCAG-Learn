...
export default function SkipLink() {
  function skipToMain(event: { preventDefault: () => void }) {
    ...
    // Deferred one frame: VoiceOver misses focus moved synchronously inside
    // the activation it is still processing. Every focus jump in the app
    // (focusCriterionCard) defers the same way.
